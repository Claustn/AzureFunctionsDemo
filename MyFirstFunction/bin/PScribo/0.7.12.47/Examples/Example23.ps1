...
$example23 = Document -Name 'PScribo Example 23' {
    <#
        ...
        of padding can be applied to the top, right, bottom and left of each table. The
        ...
        all table cells. NOTE: a -BorderWidth has been specified to demonstrate the padding
        but is not required!
    #>
...
$example23 | Export-Document -Format Html -Path ~\Desktop

# SIG # Begin signature block
# MIIXtwYJKoZIhvcNAQcCoIIXqDCCF6QCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUFCOB75g0nf5iTCPJuQTvTYIq
# X8ygghLqMIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUEgGaL096Whkg0wrRhg4+vWYYoQQwDQYJKoZI
# hvcNAQEBBQAEggEAnJuhDEapR4psRoPQQlqQQQQVogxpF2/r8UtnuTJ2mFHVHQy6
# mz8hGuQLW2rympmtMoiQlf6HMOkS3zKkKXCLV5Baca+lOcOLdboZGy8o8XCpAZPd
# Lykjwvf+pANf4cMx/ni5yryOxT4iOfgWZmshvEVWihqz2gLtHzuUzsMiOejET7UJ
# KbEepunbiTbIzCYDuJ+r4tZHCrfkU6JsmOnSlWsITnTN9yQq0o23upAQH3boReJj
# Jqb3KkWZseAjm6oxD1GKeemY/dGB6wOKVaWn1zNgW20IwvgjTmyRrewIkpqEbv4D
# hMNTNRdi411yy7cr7Y3zeWisWjLi+CMJxSVBEKGCAgswggIHBgkqhkiG9w0BCQYx
...
# MTJaMCMGCSqGSIb3DQEJBDEWBBS1v/m5VjGF+BclkALjRajjz0JsyzANBgkqhkiG
# 9w0BAQEFAASCAQBnIEepJfEXxynFunGGaXGZ1Z/IP2TdWc9kpEnsr+E69RtEWzMM
# 9qJqjzFMeSzPbAdeYt026WcB0LJbinwz5WCntDUvr+UDsGylnxCy+7p2dhK6krT+
# A38K16JnoOIcb+Tahzh7BuaJEN5jf25Es3xLdDSZsvjEiIUosF9fVdAWOV/WABL3
# 71rqdL7UxQUIAKp33q3Wqtqrpawfohzd5M6UluBxvPcFJzo2+jK15REevtxVQbC1
# vcUbWt4Ine8IX6tE3ul5sUqWCWcSgu8qAhvU2obAZgaettI4fWubuBCJIV78fRx9
# 1l6OTJur1DeogEBDUCxwa66FcCkT4tbgIySE
